  ...
  return `
    <div id="modal-quick-journal" class="modal-overlay">
        <div class="modal-card">
            ...
            <form hx-post="/journal" hx-swap="none" hx-on:htmx:after-request="closeModal('modal-quick-journal'); showToast('Saved', 'Journal entry saved.', 'success'); this.reset();">
                <input type="hidden" name="entryType" value="WORK_LOG">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="form-label">What did you work on?</label>
                        <textarea name="content" class="form-input" rows="4" placeholder="I implemented the new dashboard UI..." required></textarea>
                    </div>
                    <div class="form-group">
